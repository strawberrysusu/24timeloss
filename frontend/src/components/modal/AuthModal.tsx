  ...
  return (
    <div className="modal-overlay show" onClick={onClose}>
      <div className="modal-box" onClick={(event) => event.stopPropagation()}>
        ...
        <a href="/oauth2/authorization/naver" className="btn btn-outline modal-social-btn modal-naver-btn">
          <span className="modal-naver-icon">N</span>
          네이버로 {mode === "login" ? "로그인" : "가입"}
        </a>
        <a href="/oauth2/authorization/google" className="btn btn-outline modal-social-btn modal-google-btn">
